...
MICRONAUT_CLI_DEPS = [
    _maven("info.picocli:picocli"),
    _maven("io.micronaut.picocli:micronaut-picocli"),
]

MICRONAUT_CLI_PROCESSOR_DEPS = [
    _maven("info.picocli:picocli-codegen"),
]

MICRONAUT_CLI_PROCESSORS = [
