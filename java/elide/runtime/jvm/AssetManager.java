...
public final class AssetManager {
    ...
    public static final class ManagedAsset<M extends Message> implements Comparable<ManagedAsset> {
        ...
        /** Logic references that constitute this managed asset, including deps, in reverse topological order. */
    ...
    /**
     * Acquire a new instance of the asset manager. The instance provided by this method is not guaranteed to be fresh
     * for every invocation (it may be a shared object), but all operations on the asset manager are threadsafe
     * nonetheless.
     *
     ...
     *
     * <p>This code path is generally used for resolving metadata for an asset so it can be <i>referenced</i>. The
     * serving for URL generated for the asset refers to a specific content block with an opaque token, rather than the
     * module name, which refers to a bundle of assets or content.</p>
     *
